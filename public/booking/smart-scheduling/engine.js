 ...
 *
 * Load order: normalize.js → gaps.js → candidates.js → score.js → engine.js → moves.js → day-analysis.js → priorities.js → assign.js → cancellation-recovery.js → waitlist.js → recovery-planner.js → gap-planner.js → global-plan.js → salon-plan.js → multi-service.js → parallel-multi-service.js → resource-aware-multi-service.js → flexible-visit.js → client-offers.js → offer-revalidation.js → offer-acceptance.js → booking-execution-adapter.js → atomic-booking-simulator.js
 *
