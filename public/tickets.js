...
import { initTicketsModal, openTicketModal, ffFormatReviewedAt, closeTicketModal, closeTicketDetailsModal, addServiceToTicket, addProductToTicket, saveTicket } from "./tickets-modal.js?v=20260818_service_duration";
import { initTicketsCatalogUI, _ffEnsureCatalogEditorPortal, _ffServicesMobileShowList, openServicesModal, closeServicesModal, renderServicesCatalogV2, ffServiceStaffPermissionTrue, canStaffSendNewTicket, getStaffDefaultServiceCommission, getStaffDefaultSupplyDeduction, _ffCatalogEditorClose, addServiceCategoryV2, addSharedServiceV2 } from "./tickets-catalog-ui.js?v=20260818_service_duration";
import { initTicketsNav, goToTickets, goToServices } from "./tickets-nav.js?v=20260818_service_duration";
import { loadAndRenderTicketsSummary, populateTicketsEmployeeSelect, syncTicketsTimePeriodSelectOptions, ensureTicketsSummaryDefaultTimePeriod, setupTicketsDateFilters } from "./tickets-summary.js?v=20260818_service_duration";
import { initTicketsPicker, setupTicketsUI, ffTicketServiceSearchClear, ffTicketServiceSearchSetVisible, updateNewTicketButtonVisibility, ensureTicketsBackgroundSubscription } from "./tickets-picker.js?v=20260818_service_duration";
