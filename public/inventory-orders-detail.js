...
import { initOrdersDetailCommit } from "./inventory-orders-detail-commit.js?v=20260702_inventory_insights_split";
import { initOrdersDetailUi } from "./inventory-orders-detail-ui.js?v=20260702_inventory_insights_split";

export * from "./inventory-orders-detail-commit.js?v=20260702_inventory_insights_split";
export * from "./inventory-orders-detail-ui.js?v=20260702_inventory_insights_split";
