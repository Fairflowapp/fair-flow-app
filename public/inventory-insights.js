...
import { initInsightsScans } from "./inventory-insights-scans.js?v=20260702_inventory_insights_split";
import { initInsightsCompute } from "./inventory-insights-compute.js?v=20260702_inventory_insights_split";

export * from "./inventory-insights-scans.js?v=20260702_inventory_insights_split";
export * from "./inventory-insights-compute.js?v=20260702_inventory_insights_split";
export * from "./inventory-insights-ui.js?v=20260702_inventory_insights_split";
