 ...
 */
import { initModalView, openTicketModal, ffFormatReviewedAt, toggleTicketReviewed, openAdminTicketView, closeTicketModal, openTicketDetailsModal, closeTicketDetailsModal, ffTicketRequiresCustomerName, ffApplyTicketCustomerRequiredUI, resetTicketForm } from "./tickets-modal-view.js?v=20260701_tickets_modal_split";
import { initModalEdit, populateTicketForm, syncTicketFormLinesFromDom, renderPerformedLines, renderDiff, addServiceToTicket, addProductToTicket, setupTicketFormToggles, updateTicketDiff, updateTicketTotal, paintTicketServiceUpgradeButton, setupTicketServiceUpgradeControl, saveTicket, doSendNewTicket, doFinalizeTicket, doCloseTicket } from "./tickets-modal-edit.js?v=20260701_tickets_modal_split";
