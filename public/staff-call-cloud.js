...
function buildPresenceModal() {
  ...
  modal.innerHTML = `
    <div style="width:min(420px,100%);background:#fff;border-radius:16px;padding:24px;box-shadow:0 18px 40px rgba(0,0,0,0.22);border:1px solid #e5e7eb;text-align:center;">
      ...
      <button id="ffStaffCallAcceptBtn" type="button" style="min-width:160px;padding:12px 20px;border:none;border-radius:999px;background:linear-gradient(90deg,#a855f7,#fb7185);color:#fff;font-size:16px;font-weight:700;cursor:pointer;">Accept</button>
    </div>
  `;
