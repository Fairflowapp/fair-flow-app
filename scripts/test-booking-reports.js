...
check("reports has a Clients group with Cancellations, Retention, and Spend", navSrc.indexOf('id: "clients"') !== -1 && navSrc.indexOf('label: "Clients"') !== -1 && navSrc.indexOf('id: "cancellations"') !== -1 && navSrc.indexOf('id: "client-retention"') !== -1 && navSrc.indexOf('id: "client-spend"') !== -1);
...
check("reports ui loads client spend modules", ui.indexOf("/booking/reports/client-spend-compute.js") !== -1 && ui.indexOf("/booking/reports/client-spend.js") !== -1);
