...
check("Week empty-slot create reuses Day slot helpers", calSrc.indexOf("rememberWeekSlot") !== -1 && calSrc.indexOf("offerSlotCreate(rememberWeekSlot") !== -1 && calSrc.indexOf("openAppointmentFromHit") !== -1);
