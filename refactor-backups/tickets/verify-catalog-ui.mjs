...
const MOD = fs.readFileSync('public/tickets-catalog-ui.js', 'utf8');
const NEW = fs.readFileSync('public/tickets.js', 'utf8');
const PRE = fs.readFileSync('refactor-backups/tickets/tickets.pre-catalog-ui.js', 'utf8');
const m = JSON.parse(fs.readFileSync('refactor-backups/tickets/manifest-catalog-ui.json', 'utf8'));
...
const injected = ['showToast', 'ticketConfirm', 'setupTicketsUI', 'getServiceStaffOverrides', 'controlledStaffCanProvideService'];
const imported = ['ffCanManageServices','getTicketsAccountId','normalizeSharedCategoryName','sharedCategoryId','sharedServiceCatalogItemsRef','getSharedServicesForCatalogManager','getLocationServicesForCatalogManager','loadSharedCatalogForManager','loadLocationCatalogForManager','saveSharedService','saveSharedServiceCategory','deleteSharedServiceCategory','deleteSharedService','saveSharedServiceOverride','removeSharedServiceOverride','loadSharedServiceLocationOverridesForService','saveSharedServiceLocationOverride','_applyCatalogFilter','loadServices','saveService','deleteService','loadServiceCategories','saveServiceCategory','deleteServiceCategory','ffTicketMoney','ffTicketCurSym','escapeHtml','ticketsState'];
const firebase = ['serverTimestamp', 'doc', 'updateDoc', 'db'];
...
const builtins = new Set(['if', 'for', 'while', 'switch', 'catch', 'return', 'function', 'typeof', 'await', 'new', 'async', 'String', 'Number', 'Boolean', 'Array', 'Object', 'Map', 'Set', 'Date', 'Promise', 'Math', 'JSON', 'Intl', 'isNaN', 'parseInt', 'parseFloat', 'console', 'document', 'window', 'setTimeout', 'clearTimeout', 'requestAnimationFrame', 'CustomEvent', 'Error', 'getComputedStyle', 'set', 'fn', 'cat']);
